...
public class GetDistance {
    ...
    public static void main(String[] args) {
        String start = "海南省万宁市万城镇北坡顶安置区纵一路0栋13格和14格";
        String end = "海口市秀英区书场村八队426-（新423）号2#铺面";
        String end1 = "海南省三亚市天涯区渔村路59-1号铺面";

        try {
            String startLonLat = getLonLat(start);
            String endLonLat = getLonLat(end);
            String end1LonLat = getLonLat(end1);
            ...
            System.out.println("起始地：" + start + ",经纬度：" + startLonLat);
            System.out.println("终点：" + end1 + ",经纬度：" + end1LonLat);
            Long diss = getDistance(startLonLat, end1LonLat);
            System.out.println("两点间距离：" + diss + "米");
     ...
     * 0.通过地址得到两个地址间距离
     */
    public static long getDistanceByAdress(String start, String end) throws NullPointerException {
        String startLonLat = getLonLat(start);
        String endLonLat = getLonLat(end);
        long dis = getDistance(startLonLat, endLonLat);
        return dis;
     ...
     * 1.地址转换为经纬度
     */
    public static String getLonLat(String address) throws NullPointerException {
     ...
     * 2.经纬度算出两点间距离
     */
    public static long getDistance(String startLonLat, String endLonLat) throws NullPointerException {
